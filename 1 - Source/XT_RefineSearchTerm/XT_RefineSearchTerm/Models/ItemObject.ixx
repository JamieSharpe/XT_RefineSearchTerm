...
namespace Models
{
    ...
    public:
        ...
        std::unique_ptr<char[]> GetFileExcerpt(INT64 startOffset, INT64 readLength = 0)
        {
            ...
            int readBytesCount = JCS::XWFWrapper::IO::XWF_Read(ItemHandle.value(), startOffset, fileContentBuffer.get(), readLength);
        ...
        std::wstring ExportFile()
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    outputFileStream.write(fileContentBuffer.get(), readBytesCount);
        ...
        bool OpenFile(DWORD nFlags)
        {
            ...
            {
                HANDLE xwItemHandle = JCS::XWFWrapper::IO::XWF_OpenItem(ParentVolume->hVolume.value(), ID, nFlags);
