...
namespace Models
{
    ...
    public:
        ...
        void InitialiseVolumeInformation()
        {
            ...
            bool getVolumeInformationSuccess = JCS::XWFWrapper::IO::XWF_GetVolumeInformation(hVolume, lpFileSystem.get(), lpBytesPerSector.get(), lpSectorsPerCluster.get(), lpClusterCount.get(), lpFirstClusterSectorNo.get());
