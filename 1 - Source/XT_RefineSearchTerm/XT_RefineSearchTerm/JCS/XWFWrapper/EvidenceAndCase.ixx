...
export namespace JCS::XWFWrapper::EvidenceAndCase
{
	...
	/// <returns></returns>
	std::optional<INT64> XWF_GetCaseProp(LPVOID pReserved, LONG nPropType, PVOID pBuffer, LONG nBufLen)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_GetCaseProp, L"XWF_GetCaseProp"))
		{
			return std::nullopt;
		}
	...
	{
		std::optional<INT64> returnedValue = JCS::XWFWrapper::EvidenceAndCase::XWF_GetCaseProp(nullptr, XWF::EvidenceAndCase::XWF_GetCaseProp_PropType_ID, nullptr, NULL);

		if (!returnedValue.has_value() || returnedValue < 0)
		{
			return std::nullopt;
		}
	...
	std::optional<std::wstring> XWF_GetCaseProp_Title()
	{
		...
		std::optional<INT64> returnedValue = JCS::XWFWrapper::EvidenceAndCase::XWF_GetCaseProp(NULL, XWF::EvidenceAndCase::XWF_GetCaseProp_PropType_Title, pTitle.get(), MAX_PATH);

		if (!returnedValue.has_value() || returnedValue < 0 || pTitle == nullptr)
		{
			return std::nullopt;
		}
	...
	{
		std::optional<INT64> caseCreationTime = JCS::XWFWrapper::EvidenceAndCase::XWF_GetCaseProp(NULL, XWF::EvidenceAndCase::XWF_GetCaseProp_PropType_Creation, NULL, NULL);

		if (!caseCreationTime.has_value() || caseCreationTime < 0)
		{
			return std::nullopt;
		}

		SYSTEMTIME creationTime = JCS::Utils::Int64FileTimeToSystemTime(caseCreationTime.value());
		return creationTime;
	}
	...
	std::optional<std::wstring> XWF_GetCaseProp_Examiner()
	{
		...
		std::optional<INT64> returnedValue = JCS::XWFWrapper::EvidenceAndCase::XWF_GetCaseProp(NULL, XWF::EvidenceAndCase::XWF_GetCaseProp_PropType_Examiner, pExaminer.get(), MAX_PATH);

		if (!returnedValue.has_value() || returnedValue < 0 || pExaminer == nullptr)
		{
			return std::nullopt;
		}
	...
	std::optional<std::wstring> XWF_GetCaseProp_CaseFilePath()
	{
		...
		std::optional<INT64> returnedValue = JCS::XWFWrapper::EvidenceAndCase::XWF_GetCaseProp(NULL, XWF::EvidenceAndCase::XWF_GetCaseProp_PropType_File, pFile.get(), MAX_PATH);

		if (!returnedValue.has_value() || returnedValue < 0 || pFile == nullptr)
		{
			return std::nullopt;
		}
	...
	std::optional<std::wstring> XWF_GetCaseProp_CaseDirPath()
	{
		...
		std::optional<INT64> returnedValue = JCS::XWFWrapper::EvidenceAndCase::XWF_GetCaseProp(NULL, XWF::EvidenceAndCase::XWF_GetCaseProp_PropType_Dir, pDir.get(), MAX_PATH);

		if (!returnedValue.has_value() || returnedValue < 0 || pDir == nullptr)
		{
			return std::nullopt;
		}
	...
	/// <param name="pReserved"></param>
	/// <returns></returns>
	std::optional<HANDLE> XWF_GetFirstEvObj(LPVOID pReserved)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_GetFirstEvObj, L"XWF_GetFirstEvObj"))
		{
			return std::nullopt;
		}
	...
	/// <param name="pReserved"></param>
	/// <returns></returns>
	std::optional<HANDLE> XWF_GetNextEvObj(HANDLE hPrevEvidence, LPVOID pReserved)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_GetNextEvObj, L"XWF_GetNextEvObj"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	/// </summary>
	std::optional<HANDLE> XWF_DeleteEvObj(HANDLE hEvidence)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_DeleteEvObj, L"XWF_DeleteEvObj"))
		{
			return std::nullopt;
		}
	...
	/// <param name="pReserved"></param>
	/// <returns></returns>
	std::optional<HANDLE> XWF_CreateEvObj(DWORD nType, LONG nDiskID, LPWSTR lpPath, PVOID pReserved)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_CreateEvObj, L"XWF_CreateEvObj"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<HANDLE> XWF_OpenEvObj(HANDLE hEvidence, DWORD nFlags)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_OpenEvObj, L"XWF_OpenEvObj"))
		{
			return std::nullopt;
		}
	...
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_CloseEvObj, L"XWF_CloseEvObj"))
		{
			return;
		}
	...
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_GetEvObjProp, L"XWF_GetEvObjProp"))
		{
			return std::nullopt;
		}
	...
	std::optional<WORD> XWF_GetEvObjProp_EvidenceObjectNumber(std::optional<HANDLE> hEvidence)
	{
	...
	/// <param name="pBuffer"></param>
	/// <returns></returns>
	std::optional<LONG> XWF_SetEvObjProp(HANDLE hEvidence, LONG nPropType, PVOID pBuffer)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_SetEvObjProp, L"XWF_SetEvObjProp"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<HANDLE> XWF_GetEvObj(DWORD nEvObjID)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_GetEvObj, L"XWF_GetEvObj"))
		{
			return std::nullopt;
		}
	...
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::EvidenceAndCase::XWF_GetReportTableInfo, L"XWF_GetReportTableInfo"))
		{
			return nullptr;
		}
