...
export namespace JCS::XWFWrapper::IO
{
	...
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_GetVolumeName, L"XWF_GetVolumeName"))
		{
			return;
		}
	...
	/// <param name="hVolume"></param>
	/// <returns></returns>
	std::optional<std::wstring> GetVolumeName(std::optional<HANDLE> hVolume, DWORD type = 0x1)
	{
	...
	std::optional<bool> XWF_GetVolumeInformation(std::optional<HANDLE> hVolume, LPLONG lpFileSystem, LPDWORD lpBytesPerSector, LPDWORD lpSectorsPerCluster, PINT64 lpClusterCount, PINT64 lpFirstClusterSectorNo)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_GetVolumeInformation, L"XWF_GetVolumeInformation"))
		{
			return std::nullopt;
		}
	...
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_GetProp, L"XWF_GetProp"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<BOOL> XWF_GetSectorContents(HANDLE hVolume, INT64 nSectorNo, LPWSTR lpDescr, LPLONG lpItemID)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_GetSectorContents, L"XWF_GetSectorContents"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<HANDLE> XWF_OpenItem(HANDLE hVolume, LONG nItemID, DWORD nFlags)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_OpenItem, L"XWF_OpenItem"))
		{
			return std::nullopt;
		}
	...
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_Close, L"XWF_Close"))
		{
			return;
		}
	...
	/// <returns></returns>
	std::optional<DWORD> XWF_Read(HANDLE hVolumeOrItem, INT64 nOffset, LPVOID lpBuffer, DWORD nNumberOfBytesToRead)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_Read, L"XWF_Read"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<INT64> XWF_Write(HANDLE hVolume, INT64 nOffset, LPVOID lpBuffer, DWORD nNumberOfBytesToWrite)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_Write, L"XWF_Write"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<LPVOID> XWF_GetDriveInfo(struct XWF::IO::DriveInfo* pDInfo)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_GetDriveInfo, L"XWF_GetDriveInfo"))
		{
			return std::nullopt;
		}
	...
	/// <param name="nFlags"></param>
	/// <returns></returns>
	std::optional<DWORD> XWF_SectorIO(LONG nDrive, INT64 nSector, DWORD nCount, LPVOID lpBuffer, LPDWORD nFlags)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_SectorIO, L"XWF_SectorIO"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<BOOL> XWF_GetBlock(HANDLE hVolume, PINT64 lpStartOfs, PINT64 lpEndOfs)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_GetBlock, L"XWF_GetBlock"))
		{
			return std::nullopt;
		}
	...
	/// <returns></returns>
	std::optional<BOOL> XWF_SetBlock(HANDLE hVolume, INT64 nStartOfs, INT64 nEndOfs)
	{
		if (JCS::Utils::FunctionPointerIsNull(XWF::IO::XWF_SetBlock, L"XWF_SetBlock"))
		{
			return std::nullopt;
		}
